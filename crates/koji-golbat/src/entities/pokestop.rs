...
// The `all`/`bound`/`area`/`stats` impl is identical to gym's modulo the SQL
// table name and id prefix — generated by `fort_query` to kill that drift.
#[macros::fort_query(table = "pokestop", prefix = "p")]
pub struct Query;
