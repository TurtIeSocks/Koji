...
Use these values for your "scanner project" if Kōji and Dragonite are on the **same** network.
...
Use these values for your "scanner project" if Kōji and Dragonite are on **different** networks. This will proxy the request through Dragonite Admin to Dragonite utilizing the `api_secret` value.
...
- RealDeviceMap (RDM) is marked as deprecated and support will be removed in the future.
