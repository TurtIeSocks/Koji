...
Use these values for your "golbat project" if Kōji and Dragonite are on the **same** network.
...
Use these values for your "golbat project" if Kōji and Dragonite are on **different** networks. This will proxy the request through Dragonite Admin to Dragonite utilizing the `api_secret` value.
