...
GOLBAT_DB_URL='mysql://golbat_user:golbat_password@host:3306/golbat_database'
...
#### Optionally install [PM2](https://pm2.keymetrics.io/) to run the server in the background:
