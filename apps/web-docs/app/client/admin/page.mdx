...
- Only set a single project as the golbat project
...
- `Sync` button will attempt to sync the geofence with the designated golbat project
...
- You can sync routes to the golbat project as well
