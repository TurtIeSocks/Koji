...
When presented with this screen you log in with the `KOJI_SECRET` you set in your
...
<Callout type="info" emoji="💡">
  If your project is your golbat, you can set `Golbat` to true by clicking the
  toggle switch.
</Callout>
...
#### Load the fence into Kōji again and run Pokemon route (again with save to Kōji and save to golbat DBs selected). If doing multiple fences, load the fence names into a script (check docs) and call it via API.
