...
A directory can also be used as a plugin. The directory name will be used as the plugin name and you must add the relative path from the plugin folder to the plugin entry point to your input arguments. For example, `bun my_plugin/index.ts`.

### Example Folder Structure & Usage

<FileTree>
  <FileTree.Folder name="server" defaultOpen>
    <FileTree.Folder name="algorithms" defaultOpen>
      <FileTree.Folder name="clustering" defaultOpen>
        <FileTree.Folder name="src" defaultOpen>
          <FileTree.Folder name="plugins" defaultOpen>
            <FileTree.Folder name="plugin_1" defaultOpen>
              <FileTree.File name="clustering_plugin.py" />
            </FileTree.Folder>
            <FileTree.File name="plugin_2.js" />
            <FileTree.File name="plugin_3_binary" />
          </FileTree.Folder>
        </FileTree.Folder>
      </FileTree.Folder>
      <FileTree.Folder name="routing" defaultOpen>
        <FileTree.Folder name="src" defaultOpen>
          <FileTree.Folder name="plugins" defaultOpen>
            <FileTree.Folder name="plugin_1" defaultOpen>
              <FileTree.File name="my_custom_plugin.sh" />
            </FileTree.Folder>
            <FileTree.File name="plugin_2.ts" />
            <FileTree.File name="plugin_3_binary" />
          </FileTree.Folder>
        </FileTree.Folder>
      </FileTree.Folder>
      <FileTree.Folder name="bootstrapping" defaultOpen>
        <FileTree.Folder name="src" defaultOpen>
          <FileTree.Folder name="plugins" defaultOpen>
            <FileTree.Folder name="plugin_1" defaultOpen>
              <FileTree.File name="bootstrapping_plugin.js" />
            </FileTree.Folder>
            <FileTree.File name="plugin_2.sh" />
            <FileTree.File name="plugin_3_binary" />
          </FileTree.Folder>
        </FileTree.Folder>
      </FileTree.Folder>
...
- `clustering_args="python3 plugin_1/clustering_plugin.py"` for a plugin in a directory.
- `routing_args="bash plugin_1/my_custom_plugin.sh"` when explicitly setting an interpreter.
- `bootstrapping_args="node plugin_1/bootstrapping_plugin.js"` for nested plugin entry points.
...
The main takeaway is that the first and second arguments are optional. Once Kōji finds the first argument that is prefixed by `--`, it now assumes that the rest of the arguments are meant to be passed to the plugin. If your plugin is only a single file, you can omit the interpreter and file path, or you can just omit the file path, however you cannot omit the interpreter and try to use a custom file path.
