...
Tier 2 -> koji-core: koji-db, koji-dragonite, koji-events, koji-plugins, koji-golbat
Tier 3: algorithms -> koji-core (+koji-plugins optional), macros
Tier 4: koji-service -> [koji-core,golbat,db,plugins,jobs,events,dragonite,algorithms,migration,nominatim]
